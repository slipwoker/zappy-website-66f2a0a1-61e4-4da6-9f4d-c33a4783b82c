...
document.querySelectorAll('.feature-card, .service-card, .testimonial-card, .value-card, .team-member, .why-card').forEach(el => {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "PawsAcademy משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
        ...
        if (contactForm) {
            ...
            try {
                ...
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        websiteId: '66f2a0a1-61e4-4da6-9f4d-c33a4783b82c',
                        name: data.name,
                        email: data.email,
